...
10. In this next screen, you can edit the Lambda source code.
    ...
    * And for source code, copy paste the file ```lab2/src/AnnotateRetailDataAnalytics.js```.
      * You can open the file in your Cloud9 environment by looking for the folder lab2/src on the left pane and double clicking the AnnotateRetailDataAnalytics.js file or by copying the whole thing from [here](https://raw.githubusercontent.com/amitnarayanan/retail/master/lab2/src/AnnotateRetailAnalyticsData.js)
...
20. Configure the S3 destination.
   ...
   * For the 'S3 bucket' field, the bucket that you just created should have been pre-selected. *Note that the values for the entries below extend past the code block. Make sure you copy the whole thing*
...
24. This will open up a new tab with a pre-created IAM Role and policy which you can just authorize by clicking on 'Allow'.
    ...
    ![Authorize Firehose IAM Role Creation](images/firehose_iam_role_allow_updated.png)
...
You can now jump to [Lab 3](../../lab3/instructions/lab3.md#step-f) (Step F) to lookup a forecast.
