...
4. Click on 'Create a Forecast'. Leave 'Forecast types - *optional*' blank.

   ![Create Forecast](images/create_forecast_updated.png)
...
1. After the forecast generation is complete, we can look up lookup forecasts for specific items. Navigate back to the [Amazon Forecast console](http://console.aws.amazon.com/forecast), Click on your Dataet Group Name, and then click on 'Lookup Forecast'

   ![Forecast Dashboard](images/dashboard.png)

2. In the 'Forecast lookup' screen, choose a name for the 'Forecast'. In our case, it is 'OctForecast'
